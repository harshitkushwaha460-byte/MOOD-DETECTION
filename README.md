...
The project combines **Computer Vision**, **Deep Learning**, and **Generative AI** to create an intelligent assistant that not only recognizes emotions but also offers supportive, context-aware wellness guidance.
